package com.srvc.config.social;

import com.srvc.repository.SocialUserConnectionRepository;
import com.srvc.repository.CustomSocialUsersConnectionRepository;
import com.srvc.security.social.CustomSignInAdapter;
...
public class SocialConfiguration implements SocialConfigurer {
    ...
    // Provides data access operations that apply across multiple user records. Also acts as a factory for a user-specific
    @Override
